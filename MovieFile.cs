...
namespace MediaLibrary
{
    public class MovieFile
    {
        ...
        public void findMovie(string search)
        {
            // var movies = Movies.Where(movies => movies.title.Contains(search));
            // Console.WriteLine(movies);

            IEnumerable<Movie> movieTest = Movies.Where(t => t.title.Contains(search));

            foreach (Movie t in movieTest)
            {
